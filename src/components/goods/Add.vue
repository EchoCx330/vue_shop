...
<!--    tab栏区域-->
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-position="top" class="demo-ruleForm">
  ...
  methods:{
    ...
    add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        //执行添加的业务逻辑
        //此处需要转换，但转换后为字符串形式，双向绑定的级联选择器需要数组形式，由于改变会报错
        //lodash cloneDeep(obj)深拷贝解决
